const { createDocumentIntelligenceClient, runPrebuiltAnalysis } = require("../../document-intelligence")
...
async function noRemosMatchPdf(packingList) {
    try {
        ...
        const content = await runPrebuiltAnalysis(client, "prebuilt-read", packingList);
