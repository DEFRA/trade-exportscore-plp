/**
 * Ineligible Items Service
 *
 * Manages retrieval of NIRMS ineligible items from either local file or MDM API.
 * Acts as the entry point for ineligible items data, delegating to appropriate source.
 *
 ...
 *
 * Methods:
 * - getIneligibleItems(): Main entry point, routes to local file or MDM API
 * - getLocalIneligibleItems(): Loads data from local JSON file
 *
 * Configuration:
 * - MDM_USE_LOCAL_DATA: Toggle between local file and MDM API
 * - MDM_INELIGIBLE_ITEMS_FILE: Path to local data file (default: ./data/data-ineligible-items.json)
 */
