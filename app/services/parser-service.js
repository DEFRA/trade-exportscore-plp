...
const AsdaParser = require("./parsers/asda/model1/model1");
const AsdaMatcher2 = require("./matchers/asda/model2");
const AsdaParser2 = require("./parsers/asda/model2/model2");
const BandMMatcher = require("./matchers/bandm/model1");
const BandMParser = require("./parsers/bandm/model1/model1");
const BuffaloadMatcher = require("./matchers/buffaload-logistics/model1");
const BuffaloadParser = require("./parsers/buffaload-logistics/model1/model1");
const CoopMatcher = require("./matchers/co-op/model1");
const CoopParser = require("./parsers/co-op/model1/model1");
const CdsMatcher = require("./matchers/cds/model1");
const CdsParser = require("./parsers/cds/model1/model1");
const DavenportMatcher = require("./matchers/davenport/model1");
const DavenportParser = require("./parsers/davenport/model1/model1");
const FowlerWelchMatcher = require("./matchers/fowlerwelch/model1");
const FowlerWelchParser = require("./parsers/fowlerwelch/model1/model1");
const KepakMatcher = require("./matchers/kepak/model1");
const KepakParser = require("./parsers/kepak/model1/model1");
const NisaMatcher = require("./matchers/nisa/model1");
const NisaParser = require("./parsers/nisa/model1/model1");
const NisaMatcher2 = require("./matchers/nisa/model2");
const NisaParser2 = require("./parsers/nisa/model2/model2");
const NisaMatcher3 = require("./matchers/nisa/model3");
const NisaParser3 = require("./parsers/nisa/model3/model3");
const NutriciaMatcher = require("./matchers/nutricia/model1");
const NutriciaParser = require("./parsers/nutricia/model1/model1");
const SainsburysMatcher = require("./matchers/sainsburys/model1");
const SainsburysParser = require("./parsers/sainsburys/model1/model1");
const TescosMatcher = require("./matchers/tescos/model1");
const TescosParser = require("./parsers/tescos/model1/model1");
const TescosMatcher2 = require("./matchers/tescos/model2");
const TescosParser2 = require("./parsers/tescos/model2/model2");
const TescosMatcher3 = require("./matchers/tescos/model3");
const TescosParser3 = require("./parsers/tescos/model3/model3");
const TjMorrisMatcher = require("./matchers/tjmorris/model1");
const TjMorrisParser = require("./parsers/tjmorris/model1/model1");
const GiovanniMatcher = require("./matchers/giovanni/model1");
const GiovanniParser = require("./parsers/giovanni/model1/model1");
const WarrensMatcher = require("./matchers/warrens/model1");
const WarrensParser = require("./parsers/warrens/model1/model1");
