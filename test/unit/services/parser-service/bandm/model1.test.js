...
describe("matchesBAndMModel1", () => {
  ...
  test("AC7: matches BAndM Model 1 file, returns all_required_fields_present as false for prohibited item with treatment type", async () => {
    const result = await parserService.findParser(
  ...
  test("AC9: matches BAndM Model 1 file, returns all_required_fields_present as false for prohibited item without treatment type", async () => {
    const result = await parserService.findParser(
