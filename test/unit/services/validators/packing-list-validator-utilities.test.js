const {
    hasMissingDescription, hasMissingIdentifier, hasMissingNetWeight, hasMissingPackages,
    wrongTypeForPackages, wrongTypeNetWeight, removeBadData, removeEmptyItems
...
describe("validator function tests", () => {
    ...
    test.each([
        ...
        [null, "np", null, true],
        [null, null, "tp", true],
    ])("hasMissingIdentifier", (commodity_code, nature_of_products, type_of_treatment, expected) => {
