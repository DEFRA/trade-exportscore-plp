...
describe("validatePackingListByIndexAndType", () => {
    test("valid data", () => {
        ...
        const result = packingListValidator.validatePackingListByIndexAndType(packingList);
...
describe("generateFailuresByIndexAndTypes", () => {
    test("valid data", () => {
        ...
        const result = packingListValidator.generateFailuresByIndexAndTypes(validationResult);
    ...
    test("multiple failures", () => {
        ...
        expect(result.hasAllFields).toBeFalsy();
        expect(result.failureReasons).toContain("Total net weight is invalid in row 1.\n");
        expect(result.failureReasons).toContain("Description is missing in rows 1 and 2.\n");
    });
...
describe("generateFailureReasonFromRows", () => {
    test.each([
        ...
        ["description", [1, 2, 3, 4], "description in rows 1, 2, 3 in addition to 1 other rows.\n"],
    ])("generateFailureReasonFromRows", (description, rows, expected) => {
        const result = packingListValidator.generateFailureReasonFromRows(description, rows);
