const parser = require("../../../../../app/services/parsers/giovanni/model2");
const logger = require("../../../../../app/utilities/logger");
const model = require("../../../test-data-and-results/models/giovanni/model2");
const test_results = require("../../../test-data-and-results/results/giovanni/model2");
describe("parseGiovanniModel2", () => {
  test("parses json", () => {
